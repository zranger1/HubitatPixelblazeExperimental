/*
 ...
 2.0.x    JEM           02/04/2021  experimental -- allows effect reset on
                                    segment on/off
*/
...
var lastSwitchState = array(__max_segments)  // allows restart of effects on segment on
...
function wasSwitchedOn(z,a) {
  // return true if the switch was turned on since the last frame
  return (lastSwitchState[z] == a[__switch]) ? 0 : a[__switch]
}
...
// DEMO of how to use wasSwitchedOn() to detect when a
// segment has been turned on.
// just remove all the code in this function
// once you're done with it.
// IF YOU LEAVE THIS IN, SOLID COLORED SEGMENTS WILL BE
// WEIRDLY COLORED FOREVER!!!!
   if (wasSwitchedOn(z,a)) {
     // do whatever effect inititialization you need here.
     demoColor++;
     SetSegHSB(z, demoColor/10 ,1,1);
   }
}
